...
## <img src="https://media.giphy.com/media/4T7e4DmcrP9du/giphy.gif" width="30px">&nbsp;About Me 👨‍🎓

<img align="right" width="270px" alt="Coding GIF" src="https://media.giphy.com/media/L8K62iTDkzGX6/giphy.gif"/>

I’m a passionate **Computer Science and Robotics Engineering** student 🤖 with strong **mathematical foundations** 🧮 and solid **programming skills** 💻.  
I love exploring the intersection of **software development** and **robotic systems** that blend logic with creativity! ⚙️✨  
...
<img align="right" width="280px" src="https://media.giphy.com/media/3o7aD2saalBwwftBIY/giphy.gif"/>

- 🤖 Robot programming & control  
- 🦿 Robotic manipulation and motion planning  
- 📡 Sensor fusion & real-time data  
- ⚙️ Embedded C/C++ for microcontrollers  
- 🔋 PCB design, electronics & prototyping  

**Microcontrollers I use:**  
`Arduino` · `ESP32` · `Raspberry Pi` · `STM32` · `ATmega328`  

---

### 💻 Software Development 💾  
<img align="right" width="260px" src="https://media.giphy.com/media/VTtANKl0beDFQRLDTh/giphy.gif"/>

**Programming Languages:**  
`C` · `C++` · `Python` · `Java` · `JavaScript` · `Shell`  

**Frameworks & Tools:**  
`Flask` · `.NET Core` · `SQLAlchemy` · `Node.js` · `React` · `Bootstrap`  
...
<img align="right" width="270px" src="https://media.giphy.com/media/SWoSkN6DxTszqIKEqv/giphy.gif"/>

- 🌐 API & backend design  
- 📱 Flutter & Android app development  
- ☁️ Cloud & IoT integration (Firebase / AWS)  
- 🧩 System architecture & scalable design  

---

## 📚 Currently Exploring 🔍  
<img align="right" width="280px" src="https://media.giphy.com/media/xTiTnuhyBF54B852nK/giphy.gif"/>

- 🧠 **AI for Robotics** (perception, planning, autonomy)  
- 👁️ **Computer Vision** (OpenCV, 3D mapping, object tracking)  
...
<p align="center">
  <img width="48%" src="https://github-readme-stats.vercel.app/api?username=wirtengine&show_icons=true&theme=tokyonight&hide_border=true" />
  <img width="48%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=wirtengine&layout=compact&theme=tokyonight&hide_border=true" />
</p>
